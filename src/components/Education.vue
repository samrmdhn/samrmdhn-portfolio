<template>
    <div id="education" style="display: relative; margin-top: 20px;">
        ...
        <b-row>
            <b-col>Sman 1 Baleendah</b-col>
            <b-col>Science</b-col>
            <b-col>2015 - 2018 (Graduated)</b-col>
       
        </b-row>
        <b-row>
            <b-col>Politeknik Piksi Ganesha</b-col>
            <b-col>Informatics Management</b-col>
            <b-col>2018 - 2022 (Graduated)</b-col>
